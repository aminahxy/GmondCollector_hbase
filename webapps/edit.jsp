...
<%
    ...
    session.setAttribute("register_name",register);
...
<form action="./update.jsp"  class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <textarea name="ex" class="form-control" rows="3" id="ex" ><%=ex%></textarea>
    ...
    <div class="form-group">
        <label  class="col-sm-2 control-label"></label>
        <div class="col-sm-7">
            <input name="sms_enable" class="uniform_on" type="checkbox" id="sms_enable" checked="1" value="1" onclick="enableSMS(this)">Enable
