...
<form action="./save.jsp"  class="form-horizontal" role="form">

    <legend>Metric Setting</legend>
    <div class="form-group">
        <label for="register_name" class="col-sm-2 control-label">Register Name</label>
        <div class="col-sm-7">
            <input name="register_name" class="form-control" id="register_name"
            >
        </div>
    </div>
    <div class="form-group">
