...
<%
        String[] clusters = {
                "gzns-lizhu","nj01-jiuying","mix-test","nj01-pegasus","cq02-baihua","yq01-baize","nj01-nanling","szwg-ecomon","szwg-ston","szwg-stoff","szwg-lu",
                "nj01-yulong","nmg01-khan","nmg01-mulan","nmg01-taihang","nmg01-global",
                "yq01-wutai","yq01-heng","yq01-bdl","nmg01-luwu"
        };
         //  System.out.println(single.get_phy(clusterName).length);
        //for (int i=0;i<6;i++)
       // {
       // System.out.println(single.get_phy(clusterName)[i]);
       // } 
...
<html lang="en" class=" js no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                ...
                <div class="navbar">
                    ...
                    <a class="navbar-brand visible-lg visible-md" href="./main.jsp">
                        ...
                        <ul class="dropdown"   style="width:900px; margin:0 auto;top:15px;" >
                            ...
                            <li>
                               <form action="http://tentacles.dmop.baidu.com:8010/normandy_resource_1.jsp"  method="GET" target="main_display">
 ...
 <iframe src="welcome_normandy_resource.html"  id="iframepage" name="main_display" allowTransparency="false" width=100%   height=1000 frameborder="0" marginheight=55px  scrolling=yes  onLoad="iFrameHeight()"></iframe>
