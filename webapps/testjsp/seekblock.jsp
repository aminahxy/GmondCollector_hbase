...
<html lang="en" class=" js no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <body class="">
        ...
        <iframe src="welcome_seek_block.html"  id="iframepage" name="main_display" allowTransparency="false" width=100%   frameborder="0" marginheight=55px  scrolling=no  onLoad="iFrameHeight()"></iframe>
