...
<%
    ...
    Map<String, Map<Object,Map<String,Map<String,Object>>>> resMap =
            GetClusterMetaInstanceInService.displayClusterMetaInstance(clusterName);

        for (Map.Entry<String, Map<Object,Map<String,Map<String,Object>>>> entry : resMap.entrySet() ) {
            out.println("<br>");
            out.println("========================================================");
            out.println("<br>");
