...
<%
        String[] clusters = {
                "nj01-nanling","szwg-ecomon","szwg-ston","szwg-stoff","szwg-kun","szwg-lu",
...
<html lang="en" class=" js no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <body class="">
                ...
                <div class="navbar">
                    ...
                    <a class="navbar-brand visible-lg visible-md" href="./main.jsp">
                        ...
                        <ul class="dropdown"   style="width:900px; margin:0 auto;top:15px;" >
                            ...
                            <li>
                               <form action="http://q.dpfhelp.dmop.baidu.com:8888/dpfhelp/quota_tree_list"  method="GET" target="main_display">
        ...
        <iframe src="welcome_quota_tree.html"  id="iframepage" name="main_display" allowTransparency="false" width=100%   height=1000 frameborder="0" marginheight=55px  scrolling=yes  onLoad="iFrameHeight()"></iframe>
