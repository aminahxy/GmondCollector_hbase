            ...
            <table id="example" class="display dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example_info"
                ...
                %><tr>
                    ...
                    <td>
                        ...
                        <p>
                            <a href="./view.jsp?register=<%=register.get(i)%>" target="_top">
                        ...
                        <p><a href="./xxx.jsp" target="_top"><button type="button" class="btn btn-danger" width=100px >删除</button></a></p>
                    </td>
                </tr><%
                    }
                %>
