...
<%
        String[] clusters = {
                "hadoop-2.4.0-master","hadoop-2.4.0_slave",
        };
                ...
                <div class="navbar">
                    ...
                    <a class="navbar-brand visible-lg visible-md" href="./main.jsp">
                        ...
                        <ul class="dropdown"   style="width:900px; margin:0 auto;top:15px;" >
                            ...
                            <li>
                               <form action="hostcheckbox.jsp"   method="POST" target="main_display">
                                    <B>Metrics:</B><select name="Metrics">
                                    <%
                                         ...
                                         for(metricInfo mf:info) {
                                             String passValue = mf.getMetricId() + ":" + mf.getMetricName();
                                                    out.println("<option value=\"" + passValue + "\" selected>" 
                                                                + mf.getMetricName() + "</option>");
                                         }
                                    %>
                                     </select>
