...
<%
        String[] clusters = {
                ...
                "szjjh-dbuild","nj01-rp","yq01-wutai","yq01-heng","yq01-global","idle"
        };
...
<html lang="en" class=" js no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link href="blkcss/main.css" rel="stylesheet">
            ...
            <div class="container-fluid">
                <div class="navbar">
                    ...
                    <a class="navbar-brand visible-lg visible-md" href="./main.jsp">
                        <img src="resources/logo-seekblock.png" alt="Jump start">
                    </a>
                    </div>
                        ...
                        <ul class="dropdown"   style="width:900px; margin:0 auto;top:15px;" >
                            ...
                            <li>
                               <form action="block_find.jsp"   method="POST" target="main_display">
                                    ...
                                    %>
                                     ...
                                     <B>&nbsp;block id:</B><input size="25" style="width:222px;height:21px"  maxlength="50" name="blockId"  type="text" />
