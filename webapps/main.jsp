...
<html lang="en" class=" js no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <body class="">
        ...
        <!--input id="sub_button" class="btn btn-primary " type="submit" value="监控查看" /-->
            <br>
            <br>
            <br>
            <form action="" method="post">
                ...
                <div>
                 <br>
                <input type="radio" name="targ" value="/.jsp" onclick="Action(this)"  checked=checked/> 单台机器纵向比较
                <br/>
                 </div>
                <div>
                    <br>
                    <input type="radio" name="targ" value="/1.jsp" onclick="Action(this)"  /> 多台机器横向比较
                    <br/>
                </div>
                <div>
                    <br>
                    <input type="radio" name="targ" value="/demo_test.jsp" onclick="Action(this)" /> 集群总体指标情况
                    <br/>
                </div>

                <!--input type="submit" name="sbm" value="提交" /-->
                <input id="sub_button" class="btn btn-primary " name="sbm" type="submit" value="监控查看">
            </form>
            <script type="text/javascript">
                function Action(e)
                {
                    e.form.action = e.value;
                   // e.form.sbm.value='提交到('+e.form.action+')';
                }
            </script>
